...
using CsharpTemplate.Framework.DriverObjectFactory;
...
namespace CsharpTemplate.Hooks
{
    ...
    public class ConfigurationHooks
    {
        ...
        public static void SetConfiguration(IObjectContainer objectContainer)
        {
            ...
            var internalApiConfig = configurationroot.GetSection("InternalApiConfiguration").Get<InternalApiConfiguration>();
